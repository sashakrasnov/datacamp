...
names_1881 = pd.read_csv('../datasets/baby-names/names1881.csv', header=None, names=['name', 'gender', 'hour'])
names_1981 = pd.read_csv('../datasets/baby-names/names1981.csv', header=None, names=['name', 'gender', 'hour'])

...
df = pd.read_csv('../datasets/literacy_birth_rate.csv').iloc[:162]

female_literacy = df.female_literacy.astype('float').values
...
# bokeh serve --show 06-updating-data-sources-from-dropdown-callbacks.py
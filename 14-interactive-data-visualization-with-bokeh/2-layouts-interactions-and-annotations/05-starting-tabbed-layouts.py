...
p1 = figure(
    ...
    y_axis_label='mortality', title='America')

p1.circle(
    america.fertility.values,
    america.child_mortality.values)

p2 = figure(
    x_axis_label='fertility (children per woman)',
    y_axis_label='mortality', title='Asia')

p2.circle(
    asia.fertility.values,
    asia.child_mortality.values)

p3 = figure(
    x_axis_label='fertility (children per woman)',
    y_axis_label='mortality', title='Africa')

p3.circle(
    africa.fertility.values,
    africa.child_mortality.values)

p4 = figure(
    x_axis_label='fertility (children per woman)',
    y_axis_label='mortality', title='Europe')

p4.circle(
    europe.fertility.values,
    europe.child_mortality.values)

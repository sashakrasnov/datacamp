...
In this exercise, you'll plot female_literacy vs fertility and population vs fertility in two plots using the same ColumnDataSource.
...
data = pd.read_csv('../datasets/literacy_birth_rate.csv').iloc[:162]

data['female_literacy'] = data.female_literacy.astype('float')
data['fertility'] = data.fertility.astype('float')

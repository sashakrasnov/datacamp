...
Sometimes, low contrast images can be improved by rescaling their intensities. For instance, this image of Hawkes Bay, New Zealand at https://commons.wikimedia.org/wiki/File:Unequalized_Hawkes_Bay_NZ.jpg (originally by Phillip Capper, modified by User:Konstable, via Wikimedia Commons, CC BY 2.0) has no pixel values near 0 or near 255 (the limits of valid intensities).
...
image = plt.imread('../datasets/800px-Unequalized_Hawkes_Bay_NZ.jpg')

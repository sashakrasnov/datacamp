...
In this exercise, you will load & display an image of an astronaut at https://en.wikipedia.org/wiki/File:Astronaut-EVA.jpg (by NASA (Public domain), via Wikimedia Commons). You will also examine its attributes to understand how color images are represented.
'''
...
*   Load the file '600px-Astronaut-EVA.jpg' into an array.
...
img = plt.imread('../datasets/600px-Astronaut-EVA.jpg')

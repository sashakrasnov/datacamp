...
*   Plot the simulated AR procesees:
    *   Let ar1 represent an array of the AR parameters [1, −<phi>] as explained above. For now, the MA parmater array, ma1, will contain just the lag-zero coefficient of one.

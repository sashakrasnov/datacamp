...
MSFT = pd.read_csv('../datasets/MSFT.csv', index_col=0, parse_dates=True)
...
#MSFT = MSFT.resample(rule='w', how='last') # old, deprecated syntax
MSFT = MSFT.resample(rule='w').last() # new syntax
